...
{
    [DbContext(typeof(Way2BillDbContext))]
    [Migration("20220214125913_Way2BillFirst")]
    partial class Way2BillFirst
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Way2bill.Models.BranchMaster", b =>
                {
            ...
            modelBuilder.Entity("Way2bill.Models.CompanyMaster", b =>
                {
                    b.Property<int>("Companyid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Way2bill.Models.ComplainMaster", b =>
                {
            ...
            modelBuilder.Entity("Way2bill.Models.CustomerMaster", b =>
                {
            ...
            modelBuilder.Entity("Way2bill.Models.FeedbackMaster", b =>
                {
                    b.Property<int>("Fid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Way2bill.Models.ProductMainCategoryMaster", b =>
                {
                    b.Property<int>("Prodcatid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Prodcatid"), 1L, 1);

                    b.Property<string>("Prodcatimage")
                        .IsRequired()
                        .HasColumnType("varchar(200)");

                    b.Property<string>("Prodcatname")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Way2bill.Models.ProductSubCategoryMaster", b =>
                {
                    b.Property<int>("Prodscid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Prodscid"), 1L, 1);
                    ...
                    b.Property<int>("Prodpriceperunit")
                        .HasColumnType("int");

                    b.Property<string>("Prodscdesc")
                        .IsRequired()
                        .HasColumnType("varchar(200)");

                    b.Property<string>("Prodscname")
                        .IsRequired()
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("Way2bill.Models.QuestionMaster", b =>
                {
                    b.Property<int>("Qid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
